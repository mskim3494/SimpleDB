# 23500 Lab 3: Query Optimization
...
slides</a> from an old MIT class).
...
to do this is to change to your project directory 
...
to review the lab 2 parser exercise
...
query optimization! *You cannot complete more than 4 bonus exercises and each 
numbered item can only be done once*.
Please be sure to specify in your write up the bonus exercises you completed.

***
**Bonus Exercises.** Each of these bonuses is worth up to 5% extra credit:

1.  *Add code to perform more advanced join cardinality estimation*.
...
3.  *A cost model that accounts for caching*.  The methods to
...
4.  *Improved join algorithms and algorithm selection*.  Our
...
5.  *Bushy plans*.  Improve the provided <tt>orderJoins()</tt> and other helper
...
You will use chisubmit for lab3. *You must get your code into the master branch before Submitting*

If your code is in a branch lab3 you should do
...
Please submit (friendly!) bug reports to piazza.
