# 23500 Lab 2: SimpleDB Operators
...
Note that we will cover joins next week in class, but you should be able to get 
...
Undergraduates will work on the same team that they used for lab1. Graduates will work alone.
...
You will use chisubmit for assignment lab2.
...
Please submit (friendly!) bug reports to us via email.
